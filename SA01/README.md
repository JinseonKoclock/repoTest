...
- Tu peux ouvrir un terminal et te déplacer à l'intérieur de tes dossiers à l'aide de la commande `cd`
  - Place toi dans ton dossier `/var/www/html`
- Si tu veux voir le contenu du dossier dans lequel tu te trouves, tu peux utiliser `ls`. Et si tu veux voir dans quel dossier tu es, tu peux utiliser `pwd`
- Lorsque tu es à l'endroit qui t'intéresse, tu peux créer un **nouveau dossier** pour le challenge du jour. Pour cela, tu auras besoin de la commande `mkdir`
  - tu as le choix pour le nom du dossier à créer, libre à toi. Si tu manque d'inspiration, tu peux l'appeler `Presentation`
